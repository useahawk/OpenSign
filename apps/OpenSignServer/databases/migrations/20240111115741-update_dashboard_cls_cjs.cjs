...
exports.up = async Parse => {
  ...
  return updatedashboard.save(null, { useMasterKey: true });
};
      ...
      columns: [
        {
          ...
          widget: {
            ...
            data: {
              ...
              class: 'contracts_Document',
              query:
                'where={"IsDeclined":{"$ne":true},"IsCompleted":{"$ne":true},"Type":{"$ne":"Folder"},"Placeholders":{"$ne":null},"ExpiryDate":{"#*gt":{"__type":"#Date#","iso":"#today#"}}}&include=Signers,AuditTrail.UserPtr',
              key: 'count',
              Redirect_type: 'Report',
              Redirect_id: '4Hhwbp482K',
              tourSection: 'tourcard1',
        ...
        },
        {
          ...
          widget: {
            ...
            data: {
              ...
              class: 'contracts_Document',
              query:
                'where={"CreatedBy":{"__type":"Pointer","className":"_User","objectId":"#UserId.objectId#"},"IsCompleted":{"$ne":true},"IsDeclined":{"$ne":true},"Type":{"$ne":"Folder"},"Placeholders":{"$ne":null},"ExpiryDate":{"#*gt":{"__type":"#Date#","iso":"#today#"}}}&count=1',
              key: 'count',
              Redirect_type: 'Report',
              Redirect_id: '1MwEuxLEkF',
              tourSection: 'tourcard2',
